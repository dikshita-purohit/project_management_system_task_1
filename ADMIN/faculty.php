...
<style>
   ...
   .nav a{
        cursor:pointer; border: 3px solid black; padding: 10px; font-size: 20px; text-decoration: none; color: black; 
        border-radius: 25px;
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" class="nav">
  <tr style="background-color: rgb(255,255,255, 0.5);">
    ...
    <form method="post" action="fa.php">
        <br/><br/><br/><br/>
        <div style="background-color: rgb(255,255,255, 0.5);border-radius: 25px ; margin-left: 25%; alignment-adjust: central; width: 50%; padding: 10px; box-shadow: rgba(0, 0, 0, 0.17) 0px -23px 25px 0px inset, rgba(0, 0, 0, 0.15) 0px -36px 30px 0px inset, rgba(0, 0, 0, 0.1) 0px -79px 40px 0px inset, rgba(0, 0, 0, 0.06) 0px 2px 1px, rgba(0, 0, 0, 0.09) 0px 4px 2px, rgba(0, 0, 0, 0.09) 0px 8px 4px, rgba(0, 0, 0, 0.09) 0px 16px 8px, rgba(0, 0, 0, 0.09) 0px 32px 16px;">
  ...
  <tr align="center">
    <td>&nbsp;</td>
    <td colspan="2"><input style="width: 6em; cursor:pointer;border-radius: 25px; height: 2em; font-size: 20px;margin: 20px;" type="submit" name="add" value="Add" id="bt"/>
