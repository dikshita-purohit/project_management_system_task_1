...
<style>
    ...
    .nav a{
        cursor:pointer; border: 3px solid black; padding: 10px; font-size: 20px; text-decoration: none; color: black;border-radius: 25px; box-shadow: rgba(0, 0, 0, 0.17) 0px -23px 25px 0px inset, rgba(0, 0, 0, 0.15) 0px -36px 30px 0px inset, rgba(0, 0, 0, 0.1) 0px -79px 40px 0px inset, rgba(0, 0, 0, 0.06) 0px 2px 1px, rgba(0, 0, 0, 0.09) 0px 4px 2px, rgba(0, 0, 0, 0.09) 0px 8px 4px, rgba(0, 0, 0, 0.09) 0px 16px 8px, rgba(0, 0, 0, 0.09) 0px 32px 16px;
    }
    .nav a:hover{
  ...
  <tr style="background-color: rgb(255,255,255, 0.5);">
    ...
    <table width="100%" cellpadding="0" cellspacing="0" border="0" align="center">
        <tr style="background-color: rgb(255,255,255, 0.5);box-shadow: rgba(0, 0, 0, 0.17) 0px -23px 25px 0px inset, rgba(0, 0, 0, 0.15) 0px -36px 30px 0px inset, rgba(0, 0, 0, 0.1) 0px -79px 40px 0px inset, rgba(0, 0, 0, 0.06) 0px 2px 1px, rgba(0, 0, 0, 0.09) 0px 4px 2px, rgba(0, 0, 0, 0.09) 0px 8px 4px, rgba(0, 0, 0, 0.09) 0px 16px 8px, rgba(0, 0, 0, 0.09) 0px 32px 16px;">   
                <th><h4>&nbsp;</h4></th>
                <th><input  style="width: 5em;  height: 2em; font-size: 15px;border-radius: 20px;padding: 5px;" type="submit" value="Compose" name="compose"/></th>
                <th>&nbsp;</th>
                <th><input style="width: 5em;  height: 2em; font-size: 15px;border-radius: 20px;padding: 5px;" type="submit" value="Inbox" name="inbox"/></th>
                <th>&nbsp;</th>
                <th><input style="width: 5em;  height: 2em; font-size: 15px;border-radius: 20px; padding: 5px;" type="submit" value="Sent Mail" name="sent"/></th>
                <th>&nbsp;</th>
        </tr>
                <?php
                ...
                <tr>
                    ...
                    <td colspan="3" align="center">
                        <br/><br/>
                        <div style="background-color: rgb(255,255,255, 0.5); width: 40%; margin-left: 5%; border: black;">
                        <br/><br/>
                        <font size="5"> To : &nbsp;&nbsp;</font> 
                        <?php
                        include '../connection.php';
                ...
                elseif (isset($_POST['inbox'])) 
                    {
                        ?>  
                            ...
                            <table width="40%" cellpadding="05" cellspacing="01" border="0" align="center" bgcolor="gray">  
                    ...
                    {
                        ?>  <table width="40%" cellpadding="0" cellspacing="2" border="0" align="center" bgcolor="gray">  
